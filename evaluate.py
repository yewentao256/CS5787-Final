...
if __name__ == '__main__':
    ...
    LOAD_WEIGHT_DIR = 'checkpoints/former_resize_4-3/'
    TEST_DATA_DIR = 'data-scenery-small-test'
    SAVE_DIR = 'results'
    ...
    gen.load_state_dict(torch.load(join(args.load_weight_dir, 'Gen_former_3')))
