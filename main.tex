...
\begin{thebibliography}{99}
    \bibitem{Bertalmio2000} Bertalmio, M., Sapiro, G., Caselles, V., and Ballester, C. "Image Inpainting," \textit{Proceedings of SIGGRAPH}, 2000.
    \bibitem{Efros2001} Efros, A.A. and Freeman, W.T., "Image quilting for texture synthesis and transfer," \textit{Proceedings of SIGGRAPH}, 2001.
    \bibitem{Criminisi2004} Criminisi, A., Perez, P., and Toyama, K. "Region Filling and Object Removal by Exemplar-Based Image Inpainting," \textit{IEEE Transactions on Image Processing}, 2004.
    \bibitem{Xie2012} Xie, J. et al., "Image Denoising and Inpainting with Deep Neural Networks," \textit{NIPS}, 2012.
    \bibitem{Zhang2017} Zhang, H. et al., "Generative Image Inpainting with Contextual Attention," \textit{NIPS}, 2017.
    \bibitem{Yu2018} Yu, J. et al., "Generative Image Inpainting with Contextual Attention," \textit{CVPR}, 2018.
    \bibitem{Yu2019} Yu, J. et al., "Free-Form Image Inpainting with Gated Convolution," \textit{ICCV}, 2019.
    \bibitem{Liu2018} Liu, G. et al., "Image Inpainting for Irregular Holes Using Partial Convolutions," \textit{ECCV}, 2018.
    \bibitem{Jiahui2018} Yu, J. et al., "Generative Inpainting with Contextual Attention," \textit{CVPR}, 2018.
    \bibitem{Dosovitskiy2020} Dosovitskiy, A. et al., "An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale," \textit{ICLR}, 2021.
    \bibitem{Liu2021} Liu, Z. et al., "Swin Transformer: Hierarchical Vision Transformer using Shifted Windows," \textit{ICCV}, 2021.
    \bibitem{Zeng2022} Zeng, A. et al., "Inpainting Transformers with Multi-Scale Feature Fusion," \textit{arXiv preprint arXiv:2203.09264}, 2022.
    \bibitem{Goodfellow2014} Goodfellow, I. et al., "Generative Adversarial Nets," \textit{NIPS}, 2014.
    \bibitem{Pathak2016} Pathak, D. et al., "Context Encoders: Feature Learning by Inpainting," \textit{CVPR}, 2016.
    \bibitem{Li2017} Li, Y. et al., "Generative Face Completion," \textit{CVPR}, 2017.
    \bibitem{Song2018} Song, Y. et al., "SPG-Net: Semantic Prediction Guidance for Image Inpainting," \textit{BMVC}, 2018.
    \bibitem{Isola2017} Isola, P. et al., "Image-to-Image Translation with Conditional Adversarial Networks," \textit{CVPR}, 2017.
    \bibitem{Ronneberger2015} Ronneberger, O. et al., "U-Net: Convolutional Networks for Biomedical Image Segmentation," \textit{MICCAI}, 2015.
    \bibitem{Wang2018} Wang, X. et al., "High-Resolution Image Inpainting with Iterative Confidence Feedback and Guided Upsampling," \textit{ECCV}, 2018.
    \bibitem{Nazeri2019} Nazeri, K. et al., "EdgeConnect: Generative Image Inpainting with Adversarial Edge Learning," \textit{ICCV Workshops}, 2019.
    \bibitem{Song2019} Song, L. et al., "Geometry-Aware Face Completion and Editing," \textit{CVPR}, 2019.
    \bibitem{Yang2019} Yang, Z.X. et al., "Very Long Natural Scenery Image Prediction by Outpainting," \textit{ICCV}, 2019.
    \bibitem{Gao2022} Gao, P. et al., "Generalised Image Outpainting with U-Transformer," \textit{CVPR}, 2022.
    \bibitem{Lu2021} Lu, C.N. et al., "Bridging the Visual Gap: Wide-Range Image Blending," \textit{CVPR}, 2021.
    \bibitem{Tang2024} Tang, L. et al., "RealFill: Reference-Driven Generation for Authentic Image Completion," \textit{SIGGRAPH}, 2024.
    \bibitem{SohlDickstein2015} Sohl-Dickstein, J. et al., "Deep Unsupervised Learning using Nonequilibrium Thermodynamics," \textit{ICML}, 2015.
    \bibitem{Ho2020} Ho, J. et al., "Denoising Diffusion Probabilistic Models," \textit{NeurIPS}, 2020.
    \bibitem{Lugmayr2022} Lugmayr, A. et al., "RePaint: Inpainting Using Denoising Diffusion Probabilistic Models," \textit{CVPR}, 2022.
    \bibitem{Rombach2022} Rombach, R. et al., "High-Resolution Image Synthesis with Latent Diffusion Models," \textit{CVPR}, 2022.
    \bibitem{Dascoli2021} d’Ascoli, S. et al., "ConViT: Improving Vision Transformers with Soft Convolutional Inductive Biases," \textit{ICML}, 2021.
    \bibitem{Krizhevsky2012} Krizhevsky, A. et al., "ImageNet Classification with Deep Convolutional Neural Networks," \textit{NIPS}, 2012.
    \bibitem{LeCun1998} LeCun, Y. et al., "Gradient-Based Learning Applied to Document Recognition," \textit{IEEE Proceedings}, 1998.
\end{thebibliography}
